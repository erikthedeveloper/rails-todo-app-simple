...
class TasklistsControllerTest < ActionController::TestCase
  ...
  test "should create tasklist" do
    assert_difference('Tasklist.count') do
      post :create, tasklist: { description: @tasklist.description, name: @tasklist.name, project_id: @tasklist.project_id }
    end
  ...
  test "should update tasklist" do
    patch :update, id: @tasklist, tasklist: { description: @tasklist.description, name: @tasklist.name, project_id: @tasklist.project_id }
    assert_redirected_to tasklist_path(assigns(:tasklist))
  end
